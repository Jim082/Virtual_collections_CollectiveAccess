...
class MediaInfoCoder {
	...
	public function getMediaPath($ps_version, $pa_options=null) {
		...
		if ($va_media_info[$ps_version]["FILENAME"]) {
			...
			#	print join("/",array($va_volume_info["absolutePath"], $va_media_info[$ps_version]["HASH"], $va_media_info[$ps_version]["MAGIC"]."_".$va_media_info[$ps_version]["FILESTEM"]."_".$vn_page.".".$va_media_info[$ps_version]["EXTENSION"]));
			...
			#	print join("/",array($va_volume_info["absolutePath"], $va_media_info[$ps_version]["HASH"], $va_media_info[$ps_version]["MAGIC"]."_".$va_media_info[$ps_version]["FILENAME"]));
	...
	public function getMediaTag($ps_version, $pa_options=null) {
		...
		#print $o_media->htmlTag($va_media_info[$ps_version]["MIMETYPE"], $vs_url, $va_properties, $pa_options, $va_volume);
