		...
		public static function getViewerHTML($po_request, $ps_identifier, $pa_data=null, $pa_options=null) {
			...
			if ($o_view = BaseMediaViewer::getView($po_request)) {
				...
				if (is_a($t_instance, "ca_object_representations")) {
					...
					#print_r($va_viewer_opts); #--> Array ( [id] => caMediaOverlayTimebased_4322_detail [viewer_width] => 360 [viewer_height] => 235 ) 
					...
					#print "  ".$vs_version."  ";
					#print_r($t_instance->getMediaTag('media', $vs_version, $va_viewer_opts)); #--> image son
				...
				#print_r(BaseMediaViewer::prepareViewerHTML($po_request, $o_view, $pa_data, $pa_options));
				#print "°°°°°°fin°°°°°°°°°°°°°°°°°°°";
