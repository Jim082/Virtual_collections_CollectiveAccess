						...
						<tr>
							<td>
								<audio controls width="100%" >
									<source src="<?php print $ps_url; ?>" type="audio/wav">
									Your browser does not support the <code>audio</code> element. 
								</audio>
								<!--<embed width="<?php print $pa_properties["width"]; ?>" height="<?php print $pa_properties["height"] + 16; ?>" src="http://localhost/pawtucket/media/virtualcollections/mp3/4/3/31212_ca_object_representations_media_4322_original.mp3" type="audio/x-wav">-->
							</td>
						</tr>
					</table>
				</div>
<?php
			...
			case 'image/jpeg':
			case 'image/png':
			#print "--audiojpg--".$pa_properties["mimetype"];
				if (!is_array($pa_options)) { $pa_options = array(); }
