 ...
 */
	...
	try {
		...
		$resp->addHeader("Content-Security-Policy", "script-src 'self' maps.googleapis.com cdn.knightlab.com ajax.googleapis.com 'unsafe-inline' 'unsafe-eval' https://dev.virtualearth.net https://cdn.jsdelivr.net ;"); 
