...
<?php
				...
				print "<H5>"._t($va_facet_info['label_singular'])."</H5>"; 
				switch($va_facet_info["group_mode"]){
					...
					default:
						...
						foreach($va_facet_info['content'] as $va_item) {
							...
							if ($vs_content_count <> ""){
								print "<div style='margin-left:30px;'>".caNavLink($this->request, $va_item['label'].$vs_content_count, '', '*', '*','*', array('key' => $vs_key, 'facet' => $vs_facet_name, 'id' => $va_item['id'], 'view' => $vs_view))."</div>";
							}
							$vn_c++;
