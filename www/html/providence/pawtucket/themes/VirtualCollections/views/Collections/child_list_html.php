...
function printLevel($po_request, $va_collection_ids, $o_config, $vn_level, $va_options = array()) {
	...
	if($qr_collections->numHits()){
		while($qr_collections->nextHit()) {
			...
			$vs_output .= "<div style='margin-left:".(100*($vn_level - 1))."px;'>";
			...
			if($vb_link){
				$vs_output .= $vs_icon." ";
				if($vb_collapse_link){
					$vs_output .= "<a href='#' onClick='jQuery(\"#level".$qr_collections->get('ca_collections.collection_id')."\").toggle(); return false;'>"."<img src='/providence/pawtucket/themes/VirtualCollections/assets/pawtucket/graphics/".$qr_collections->get('ca_collections.idno').".jpg' style='width:200px;' alt='".$qr_collections->get('ca_collections.preferred_labels')."' />&nbsp;&nbsp;&nbsp;".$qr_collections->get('ca_collections.preferred_labels')."</a>";
				}else{
					$vs_output .= caDetailLink($po_request, "<img src='/providence/pawtucket/themes/VirtualCollections/assets/pawtucket/graphics/".$qr_collections->get('ca_collections.idno').".jpg' style='width:200px;' alt='".$qr_collections->get('ca_collections.preferred_labels')."' />&nbsp;&nbsp;&nbsp;".$qr_collections->get('ca_collections.preferred_labels'), '', 'ca_collections',  $qr_collections->get("ca_collections.collection_id"));
				}
				...
				$vs_output .= " ".caDetailLink($po_request,  "", '', 'ca_collections',  $qr_collections->get("ca_collections.collection_id"));
			}else{
				$vs_output .= "<span >".$vs_icon." ";
				if($vb_collapse_link){
					$vs_output .= "<a href='#' onClick='jQuery(\"#level".$qr_collections->get('ca_collections.collection_id')."\").toggle(); return false;'>"."<img src='/providence/pawtucket/themes/VirtualCollections/assets/pawtucket/graphics/".$qr_collections->get('ca_collections.idno').".jpg' style='width:200px;' alt='".$qr_collections->get('ca_collections.preferred_labels')."' />&nbsp;&nbsp;&nbsp;".$qr_collections->get('ca_collections.preferred_labels')."</a>";
				}else{
					$vs_output .= "<img src='/providence/pawtucket/themes/VirtualCollections/assets/pawtucket/graphics/".$qr_collections->get('ca_collections.idno').".jpg' style='width:200px;' alt='".$qr_collections->get('ca_collections.preferred_labels')."' />&nbsp;&nbsp;&nbsp;".$qr_collections->get('ca_collections.preferred_labels')."</a>";
				}
				$vs_output .= "</span>";
			}
