...
?>					
			<div class='text-right'>
				<a href='#' onclick='$("#collectionsWrapper").toggle(300);return false;' class='showHide'><?php print _t("Show/Hide Collection Browser"); ?></a>
			</div>
...
<?php
					if($qr_collection_children->numHits()){
						while($qr_collection_children->nextHit()) {
							...
							if($vb_link_sublist){
								print "<div class='coll_images'>";
								print "   <a href='#' class='openCollection openCollection".$qr_collection_children->get("ca_collections.collection_id")."'>";
								print "     <img src='/providence/pawtucket/themes/VirtualCollections/assets/pawtucket/graphics/".$qr_collection_children->get('ca_collections.idno').".jpg' alt='".$qr_collection_children->get('ca_collections.preferred_labels')."' />".$vs_icon." ".$qr_collection_children->get('ca_collections.preferred_labels').$vs_record_count;
								print "   </a>";
								print "</div>";
								...
								if($vb_link_to_detail){
									print caDetailLink($this->request, "<img src='/providence/pawtucket/themes/VirtualCollections/assets/pawtucket/graphics/".$qr_collection_children->get('ca_collections.idno').".jpg' alt='".$qr_collection_children->get('ca_collections.preferred_labels')."' />".$vs_icon." ".$qr_collection_children->get('ca_collections.preferred_labels')." ".(($o_collections_config->get("link_out_icon")) ? $o_collections_config->get("link_out_icon") : ""), '', 'ca_collections',  $qr_collection_children->get("ca_collections.collection_id")).$vs_record_count;
								}else{
									print "   <a href='#' class='openCollection openCollection".$qr_collection_children->get("ca_collections.collection_id")."'>";
									print "     <img src='/providence/pawtucket/themes/VirtualCollections/assets/pawtucket/graphics/".$qr_collection_children->get('ca_collections.idno').".jpg' alt='".$qr_collection_children->get('ca_collections.preferred_labels')."' />".$vs_icon." ".$qr_collection_children->get('ca_collections.preferred_labels').$vs_record_count;
									print "   </a>";
...
?>
							<div id='collectionLoad' class='col-xs-12 col-sm-8 col-md-8 col-lg-8'>
								...
								<i class='fa fa-arrow-left'></i> <?php print _t("Click to the left to see its contents."); ?>
							</div>
<?php
					}
?>
