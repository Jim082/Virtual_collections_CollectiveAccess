...
?>
		...
		<div class="form-group" style="margin:20px;">
			<?php print _t("Fields with a * are mandatory."); ?><BR><BR>
			<?php print _t("Your data and privacy are important to us, and we are committed to ensuring its absolute protection. As such, information we collect with this form is used in accordance with the guidelines set out by the GDPR."); ?>
		</div>
...
<script type='text/javascript'>
	jQuery(document).ready(function() {
		$('[name="pref_user_profile_country"] option[value="BE"]').attr('selected','selected');
