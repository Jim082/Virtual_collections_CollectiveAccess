...
<?php
		...
		print caNavLink($this->request, _t('Browse all &nbsp;<span class="glyphicon glyphicon-arrow-right"></span>'), 'browseMenuBrowseAll btn btn-default btn-sm', '', 'Browse', $vs_target, '');
?>
