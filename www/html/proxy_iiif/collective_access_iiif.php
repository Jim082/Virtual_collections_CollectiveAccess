...
try {
            ...
            $url_thumbnail="https://virtualcol.africamuseum.be/providence/pawtucket/service.php/IIIF/representation:";
            $url_thumbnail_suffix="/full/!256,256/0/default.jpg";
			$uuid=$_REQUEST["uuid"];
                ...
                $seq_json[]= '
                    {
                      ...
                      "@type":"sc:Canvas",
                      "label":"'.$i.'",
                      "thumbnail":"'.$url_thumbnail.$item['image_id'].$url_thumbnail_suffix.'",
                      "seeAlso":[
